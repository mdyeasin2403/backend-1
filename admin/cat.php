...
$insql = "INSERT INTO category(name, icon) VALUES ('$cname', '$cicon')";


if ( $conn -> query($insql) ) {
     $result = '<h2 class="text-primary">Data connect successful</h2>';
}
else{
     die( $conn -> error );
...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="admin.php">News611</a>
            <!-- Sidebar Toggle-->
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                    ...
                                    <div class="mb-3">
                                        <button class="btn btn-primary" type="Submit" name="c_submit">Submit</button>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; News611 2024</div>
                            <div>
